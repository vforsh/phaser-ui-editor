// DO NOT USE `import ` IN THIS FILE, it will break the TypeScript declaration merging
...
declare module Phaser {
	namespace Events {
		...
		interface EventEmitter {
			...
			on(event: string | symbol, fn: Function, context?: unknown, signal?: as): this
			once(event: string | symbol, fn: Function, context?: unknown, signal?: as): this
			...
			offByContext(context: unknown, eventToRemove?: string): void
		}
	}
	...
	namespace GameObjects {
		...
		type AutoSizeTextOptions =
			import('../src/components/canvas/phaser/robowhale/phaser3/gameObjects/text/AutoSizeText').AutoSizeTextOptions
		...
		interface GameObjectCreator {
			...
			image(
				config: Phaser.Types.GameObjects.GameObjectConfig & { key: string; frame: string },
				addToScene?: boolean,
			): Phaser.GameObjects.Image
			text(
				config: Phaser.Types.GameObjects.GameObjectConfig & { text?: string; style?: Phaser.Types.GameObjects.Text.TextStyle },
				addToScene?: boolean,
