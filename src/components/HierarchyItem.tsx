...
import { ChevronDown, Eye, EyeOff, Folder, Image, TextQuote, Type } from 'lucide-react'
...
export default function HierarchyItem({ item, level = 0, isLastChild = false, onToggleVisibility }: HierarchyItemProps) {
