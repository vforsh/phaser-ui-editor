...
export const AssetsSearch = forwardRef<{ handleExpand: () => void }, AssetsSearchProps>(
	({ onSearchChange, flatAssets, onSearchModeChange }, ref) => {
		...
		// Expose handleExpand method via ref
