 ...
 * @param precision - Output precision; default is `seconds`.
 * @returns строка в формате `YYYY-MM-DD hh:mm:ss.ms` или `YYYY-MM-DD hh:mm:ss` или `YYYY-MM-DD hh:mm`
 */
...
/**
 * @param dateString - Строка в формате YYYY-MM-DD hh:mm[:ss[.ms]].
 ...
 * @returns `true`, если строка строго соответствует шаблону `YYYY-MM-DD hh:mm[:ss[.ms]]`.
 */
