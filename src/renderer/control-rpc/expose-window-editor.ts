...
export function exposeWindowEditor(appCommands: AppCommandsEmitter): void {
	...
	const editor: WindowEditorApi = {
		...
		selectNode: (params) => handlers.selectNode(params),
		...
		setObjectPatch: (params) => handlers.setObjectPatch(params),
		setComponentPatch: (params) => handlers.setComponentPatch(params),
		resolveNode: (params) => handlers.resolveNode(params),
