 ...
 * - Speed up worktree creation by reusing the `master` worktree's `node_modules`.
 * - If the current lockfile matches the `master` lockfile, perform a clone-on-write copy
